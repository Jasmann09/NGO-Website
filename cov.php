...
<html lang="en">
  ...
  <body>
    ...
    <p>
        The current situation of our country is that the poor dont have sufficient resources to build the life from the bottom of the river
        they are forced to live on the streets free Homes for the Homeless is a 501 3 private, non-profit organization which provides housing and employment training for families and homeless people in New York City. It was founded in 1986 through a collaboration with Leonard N. Stern, the Cathedral of St. John the Divine, and the city of New York.[citation needed] Homes for the Homeless has adopted a family-based, child-centered, education-focused approach to its programming that aims to break the cycle of poverty.
        
    </p>
    <hr>
    <h4>Our Initiative</h4>
    <hr>
    <p>In India, Habitat for Humanity International has invested $411,000 in Tvasta Manufacturing Solutions Ltd. to boost the production of affordable 3D-printed homes. Construction using this technology is faster and generates less waste than traditional methods.
    Tvasta is working with an Indian government programme that plans to build 20 million homes for low-income families across the country by 2022. Adithya Jain, Tvastas co-founder and chief executive officer, told Reuters a 3D-printed home can be customised and put up in just five days, making it well-suited to the governments plans as well as for disaster resettlement.</p>
    <hr>
    </div>
    ...
    <aside>
        ...
        <img src="co.webp" alt="" srcset="">
    </aside>
    
    </div>
    
    <a href="pay.php" class="btn btn-primary bn">Donate to the Initiative</a>
</div>
<style>
  body{
